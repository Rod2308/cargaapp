...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cárga — seu treino de academia, do seu jeito" },
      ...
      { property: "og:title", content: "Cárga — seu treino de academia" },
      { property: "og:description", content: "Monte, registre e evolua seus treinos de academia com um coach de IA." },
