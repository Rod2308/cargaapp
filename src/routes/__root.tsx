...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TreinoAI — seu treino de academia, do seu jeito" },
      ...
      { property: "og:title", content: "TreinoAI — seu treino de academia, do seu jeito" },
      ...
      { name: "twitter:title", content: "TreinoAI — seu treino de academia, do seu jeito" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Archivo:wght@500;600;700;800;900&family=IBM+Plex+Sans:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500;600&display=swap" },
    ],
  }),
